...
<div class="animate-fadeIn text-white p-2">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10">
        ...
        <button onclick="loadSection('add_movie')" class="group bg-[#E11D48] hover:bg-[#be123c] text-white px-6 py-3 rounded-xl flex items-center gap-3 transition-all duration-300 shadow-lg shadow-rose-600/20">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <?php if(mysqli_num_rows($res) > 0): ?>
            ...
            <div class="bg-[#0a0a0a] border border-white/5 rounded-[1.5rem] p-4 flex gap-6 hover:border-[#E11D48]/40 transition-all duration-500 group relative overflow-hidden">
                ...
                <div class="relative w-28 h-40 flex-shrink-0 overflow-hidden rounded-xl shadow-2xl">
                    ...
                    <div class="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black to-transparent p-2">
                        <span class="text-[9px] font-black text-white bg-[#E11D48] px-2 py-0.5 rounded">
                ...
                <div class="flex-1 flex flex-col justify-between py-1">
                    <div>
                        <div class="flex justify-between items-start">
                            <h4 class="text-lg font-bold text-gray-100 group-hover:text-[#E11D48] transition-colors truncate w-48">
                        ...
                        <div class="flex items-center gap-3 mt-2">
                            <span class="bg-white/5 text-gray-400 border border-white/10 px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest">
                                <i class="fa fa-calendar-alt mr-1 text-[#E11D48]"></i> 
                    ...
                    <div class="flex gap-3 mt-4">
                        <button onclick="loadSection('edit_movie&id=<?php echo $m['id']; ?>')" 
                            ...
                            <i class="fa fa-edit text-[#E11D48]"></i> Edit
                        </button>

                        <button onclick="confirmDelete(<?php echo $m['id']; ?>)" 
                                class="flex-1 bg-white/5 text-gray-400 hover:text-white hover:bg-[#E11D48] py-2.5 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-widest border border-white/5">
